...
df <- seer0to39 %>%
  filter(can_type == "III. CNS and miscellaneous intracranial and intraspinal neoplasms"|can_typeAYA == "3. CNS and Other Intracranial and Intraspinal Neoplasms (all behaviors)") %>%
  group_by(can_type, can_typeAYA)%>%
  tally()
```
